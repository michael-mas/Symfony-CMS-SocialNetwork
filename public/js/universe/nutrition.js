...
$(document).ready(function(){
    ...
    $(".calculate").on('click touchstart', function(){
        ...
        if (goal == 1) {
            ...
            $(".protein").html(pro + " grammes de protéines" + " or " + pro_per + " grammes par repas");
            $(".carbs").html(carbs + " grammes de glucides" + " or " + carbs_per + " grammes par repas");
            $(".fats").html(fats + " grammes de lipides" + " or " + fats_per + " grammes par repas");
        } else if (goal == 2) {
            ...
            $(".protein").html(pro + " grammess de protéines" + " or " + pro_per + " grammes par repas");
            $(".carbs").html(carbs + " grammes de glucides" + " or " + carbs_per + " grammes par repas");
            $(".fats").html(fats + " grammes de lipides" + " or " + fats_per + " grammes par repas");
        }
