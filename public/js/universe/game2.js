class Game {
    ...
    * Display score
    ...
    showGrade(score) {
        ...
        else if(score > 25) return "Waow j'y crois pas !";
        else if(score > 20) return "Incroyable";
        else if(score > 15) return "Félicitation!";
        else if(score > 13) return "Bravo!";
        else if(score > 10) return "Bien joué!";
        else if(score > 5) return "Vraiment?";
        else return "Mon pauvre...";
    }
