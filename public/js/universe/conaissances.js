    ...
    if(searchText.value !== ""){
        ...
        fetch(url).then(response => response.json()).then(data =>{
            ...
            data.query.search.forEach(items =>{
                ...
                searchResult.insertAdjacentHTML(`afterBegin` , `<div class="resultItem"><div class="boxClose"><a href="" class="clodeBtn">X</a></div>
            <a href="${resultURL}" target="_blank" class="resultTitle">${items.title}
